...
const provinces = JSON.parse(fs.readFileSync(path.join(__dirname, '../../../hcm_provinces.json'), 'utf8'));
const districts = JSON.parse(fs.readFileSync(path.join(__dirname, '../../../hcm_districts.json'), 'utf8'));
const wards = JSON.parse(fs.readFileSync(path.join(__dirname, '../../../hcm_wards.json'), 'utf8'));
const insertData = () => {
